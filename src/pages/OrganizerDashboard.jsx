...
import { 
  ...
  Users, TrendingUp, PlusCircle, ArrowUpRight, MoreHorizontal, Ticket 
} from "lucide-react"
  ...
  return (
    <div className="flex min-h-[calc(100vh-4rem)] bg-muted/40">
      ...
      <aside className="w-64 border-r border-border bg-card hidden md:block">
        <div className="h-full px-3 py-6 flex flex-col gap-2">
          <div className="px-3 mb-4">
            <h2 className="text-lg font-bold tracking-tight">Organizer Panel</h2>
          </div>
          
          <div className="space-y-1">
            <Link to="/dashboard" className="flex items-center gap-3 rounded-lg px-3 py-2 bg-brand-500/10 text-brand-500 font-medium transition-colors">
              <LayoutDashboard className="h-4 w-4" />
              Overview
            </Link>
            <Link to="#" className="flex items-center gap-3 rounded-lg px-3 py-2 text-muted-foreground hover:bg-muted hover:text-foreground transition-colors">
              <Calendar className="h-4 w-4" />
              My Events
            </Link>
            <Link to="/create-event" className="flex items-center gap-3 rounded-lg px-3 py-2 text-muted-foreground hover:bg-muted hover:text-foreground transition-colors">
